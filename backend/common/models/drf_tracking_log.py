...
class APIRequestLog(models.Model):
    ...
    response_ms = models.PositiveIntegerField(
        verbose_name="Время выполнения кода представления, мс",
        default=0,
    )
    ...
    remote_addr = models.GenericIPAddressField(
        verbose_name="IP-адрес источника запроса",
        db_index=True,
    )
    ...
    query_params = models.TextField(verbose_name="Параметры запроса", blank=True)
